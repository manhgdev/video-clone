...
"""
    try:
        with tempfile.TemporaryDirectory(prefix="vc-ocr-") as td:
            ...
            # Windows: dùng MSMF thay FFmpeg cho VideoCapture — không có pthread frame assertion.
            if sys.platform == "win32":
                env["OPENCV_VIDEOIO_PRIORITY_MSMF"] = "200"
                env["OPENCV_VIDEOIO_PRIORITY_FFMPEG"] = "0"
